...
for { set i 0 } { $i < 5 } { incr i } {
    lappend at4el {*}[$mf measure -channel 9 -events {{1/4 {"closed hi-hat" "acoustic bass drum"}} {1/4 {"closed hi-hat"}} {1/4 {"closed hi-hat" "acoustic snare"}} {1/4 {"closed hi-hat"}}}]
}
